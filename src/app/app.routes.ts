...
export const routes: Routes = [
    ...
    { path: 'product-list', loadComponent: () => import('./ngrx/product/product-list/product-list.component').then(m => m.ProductListComponent) },
    { path: 'shopping', loadComponent: () => import('./ngrx/shopping/cart/cart.component').then(m => m.CartComponent) },
    { path: 'order', loadComponent: () => import('./ngrx/orders/history/history.component').then(m => m.HistoryComponent) },
